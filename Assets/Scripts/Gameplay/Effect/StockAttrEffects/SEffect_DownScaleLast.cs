...
public class SEffect_DownScaleLast : StockAttrEffect, IAutoEffect_BeforeCalc
{
    public float mul;
    public SEffect_DownScaleLast(string effectKey, string[] args, float probablity = 1, int growId = 0) : base(effectKey, args, probablity, growId)
    {

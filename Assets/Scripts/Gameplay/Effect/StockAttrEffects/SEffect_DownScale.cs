...
public class SEffect_DownScale : StockAttrEffect, IAutoEffect_BeforeCalc
{
    public float mul = 1;
    public SEffect_DownScale(string effectKey, string[] args, float probablity = 1, int growId = 0) : base(effectKey, args, probablity, growId)
    {

...
/// 属性提示框单项显示（世界空间）
/// </summary>
public class AttributeTooltipItem : MonoBehaviour
{
    [Header("世界空间组件")]
    [SerializeField] private TextMeshPro attributeNameText;
    [SerializeField] private TextMeshPro attributeDescriptionText;

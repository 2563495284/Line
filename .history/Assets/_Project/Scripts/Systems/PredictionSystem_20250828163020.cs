...
public class PredictionSystem : Singleton<PredictionSystem>
{
    ...
    private void OnEnable()
    {
        ...
        ActionSystem.SubscribeReaction<MadeInHeavenExecuteGA>(UpdatePredictionCountdown, ReactionTiming.POST);
    ...
    private void OnDisable()
    {
        ...
        ActionSystem.UnsubscribeReaction<MadeInHeavenExecuteGA>(UpdatePredictionCountdown, ReactionTiming.POST);
    }
    ...
    private void UpdatePredictionCountdown(MadeInHeavenExecuteGA madeInHeavenExecuteGA)
    {
        if (MadeInHeavenSystem.Instance.activeMadeInHeaven)
        {
